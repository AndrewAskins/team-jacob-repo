...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.rootViewController = [[ReviewTableViewController alloc] initWithNibName:@"ReviewTableViewController" bundle:nil];
    
    self.navController = [[UINavigationController alloc] initWithRootViewController:self.rootViewController];
    
    [self.navController.navigationBar setTranslucent:NO];
    self.navController.navigationBar.barTintColor = RGB(105, 210, 210);
    ...
    [[SessionManager currentSession] requestNearbyPlaces];
